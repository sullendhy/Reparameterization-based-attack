...
def main(args):
    ...
    #     str = encoded_dataset["train"][i]['sentence'].split(" ")
    #     total = total + len(str)
    # print(str)
    # print(total/len(encoded_dataset["train"]))

    train_args = TrainingArguments(
        args.checkpoint_folder,
        disable_tqdm=not args.tqdm,
        evaluation_strategy = "epoch",
        #加一个save策略 @Date2022/08/26
        save_strategy = "epoch",
...
if __name__ == "__main__":
    ...
    parser.add_argument("--dataset", default="mnli", type=str,
        choices=["dbpedia14", "ag_news", "imdb", "yelp", "mnli", "sst2", "FakeNews", "THUCNews"],
        help="classification dataset to use")

    # Model
    parser.add_argument("--model", default="bert-base-uncased", type=str,
        choices=["gpt2", "xlm-clm-ende-1024", "bert-base-uncased", "roberta-base", 
